...
|--------|------------|-------|--------|----------------------|
| **A**  | مبانی و منطق برنامه‌نویسی | 150 | ✅ 100% | سینتکس پایه، متغیر، شرط، حلقه، الگوریتم‌ها |
| **B**  | ساختار داده‌ها | 100 | 🟡 24% | لیست، دیکشنری، مجموعه، تاپل و عملیات پیشرفته |
| **C**  | توابع و ماژول‌ها | 100 | 🟡 13% | تعریف تابع، آرگومان‌ها، lambda، map، filter |
| **D**  | کار با فایل و داده | 150 | 🟡 4.7% | خواندن/نوشتن فایل، JSON، CSV |
| **E**  | برنامه‌نویسی شی‌گرا (OOP) | 150 | ✅ 100% | کلاس، وراثت، پلی‌مورفیسم |
| **F**  | ماژول‌های استاندارد | 150 | 🔴 3.3% | datetime، os، sys، random، re و … |
...
**پیشرفت کلی**: 350 از 800 مسئله تکمیل شده (43.75%)
